...
public interface UserInfoApi {
    ...
    ResponseEntity<Void> deleteUserInfo(
        @NotNull @Parameter(name = "userId", description = "identifier of the user information", required = true, in = ParameterIn.PATH) @PathVariable("userId") String userId
    );
    ...
    ResponseEntity<UserInfoOverviewType> getUserInfoById(
        @NotNull @Parameter(name = "userId", description = "User info ID", required = true, in = ParameterIn.PATH) @PathVariable("userId") String userId
    );
