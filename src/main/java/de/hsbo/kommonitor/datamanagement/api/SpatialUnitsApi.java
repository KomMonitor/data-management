...
public interface SpatialUnitsApi {
    ...
    ResponseEntity<Void> deleteSingleSpatialUnitFeatureById(
        @NotNull @Parameter(name = "spatialUnitId", description = "the identifier of the spatial-unit dataset", required = true, in = ParameterIn.PATH) @PathVariable("spatialUnitId") String spatialUnitId,
        @NotNull @Parameter(name = "featureId", description = "the identifier of the spatial-unit dataset feature", required = true, in = ParameterIn.PATH) @PathVariable("featureId") String featureId
    );
    ...
    ResponseEntity<List<PermissionLevelType>> getSpatialUnitsPermissionsById(
        @NotNull @Parameter(name = "spatialUnitId", description = "identifier of the spatial unit dataset", required = true, in = ParameterIn.PATH) @PathVariable("spatialUnitId") String spatialUnitId
    );
