...
public interface IndicatorsPublicApi {
    ...
    ResponseEntity<byte[]> getPublicIndicatorBySpatialUnitIdAndId(
        @NotNull @Parameter(name = "indicatorId", description = "unique identifier of the selected public indicator dataset", required = true, in = ParameterIn.PATH) @PathVariable("indicatorId") String indicatorId,
        @NotNull @Parameter(name = "spatialUnitId", description = "the unique identifier of the public spatial level", required = true, in = ParameterIn.PATH) @PathVariable("spatialUnitId") String spatialUnitId,
