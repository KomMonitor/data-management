...
public interface IndicatorsApi {
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = IndicatorOverviewType.class), examples = {
                    @ExampleObject(
                        name = "IndicatorOverview",
                        value = "{\"indicatorId\":\"1d2e3f40-0001-4a5b-8c9d-000000000001\",\"indicatorName\":\"Share of children under 6 years\",\"abbreviation\":\"U6\",\"creationType\":\"INSERTION\",\"indicatorType\":\"STATUS_RELATIVE\",\"unit\":\"percent\",\"isHeadlineIndicator\":true,\"isPublic\":false,\"ownerId\":\"3c9f8b12-0001-4a1b-9c33-1a2b3c4d5e01\",\"topicReference\":\"demography\",\"interpretation\":\"Higher values indicate a younger population structure.\",\"processDescription\":\"Number of children under 6 divided by total population.\",\"precision\":2,\"displayOrder\":1,\"tags\":[\"demography\",\"children\"],\"applicableDates\":[\"2020-01-01\",\"2021-01-01\"],\"applicableSpatialUnits\":[{\"spatialUnitId\":\"5a1b2c3d-0001-4e5f-8a9b-000000000001\",\"spatialUnitName\":\"districts\"}],\"regionalReferenceValues\":[{\"referenceDate\":\"2020-01-01\",\"regionalAverage\":11.2,\"regionalSum\":45230.0}],\"permissions\":[\"creator\"],\"userPermissions\":[\"creator\"],\"metadata\":{\"contact\":\"KomMonitor Team, info@kommonitor.de\",\"datasource\":\"Municipal statistics office\",\"description\":\"Share of the population that is younger than six years.\",\"updateInterval\":\"YEARLY\",\"lastUpdate\":\"2021-01-30\",\"sridEPSG\":4326}}"
                    )
                })
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = IndicatorOverviewType.class)), examples = {
                    @ExampleObject(
                        name = "IndicatorOverviewCollection",
                        value = "[{\"indicatorId\":\"1d2e3f40-0001-4a5b-8c9d-000000000001\",\"indicatorName\":\"Share of children under 6 years\",\"creationType\":\"INSERTION\",\"unit\":\"percent\",\"isHeadlineIndicator\":true,\"isPublic\":false,\"ownerId\":\"3c9f8b12-0001-4a1b-9c33-1a2b3c4d5e01\",\"topicReference\":\"demography\",\"interpretation\":\"Higher values indicate a younger population structure.\",\"tags\":[\"demography\"],\"applicableDates\":[\"2021-01-01\"],\"applicableSpatialUnits\":[{\"spatialUnitId\":\"5a1b2c3d-0001-4e5f-8a9b-000000000001\",\"spatialUnitName\":\"districts\"}],\"regionalReferenceValues\":[{\"referenceDate\":\"2021-01-01\",\"regionalAverage\":11.0}],\"metadata\":{\"contact\":\"KomMonitor Team, info@kommonitor.de\",\"datasource\":\"Municipal statistics office\",\"description\":\"Share of the population that is younger than six years.\",\"updateInterval\":\"YEARLY\",\"sridEPSG\":4326}}]"
                    )
                })
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = IndicatorPropertiesWithoutGeomType.class)), examples = {
                    @ExampleObject(
                        name = "IndicatorPropertiesWithoutGeomCollection",
                        value = "[{\"id\":\"8f14e45f-ceea-467d-9a1b-000000000101\",\"name\":\"District Centre\",\"validStartDate\":\"2020-01-01\",\"validEndDate\":\"2020-12-31\"},{\"id\":\"8f14e45f-ceea-467d-9a1b-000000000102\",\"name\":\"District North\",\"validStartDate\":\"2020-01-01\",\"validEndDate\":\"2020-12-31\"}]"
                    )
                })
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = PermissionLevelType.class)), examples = {
                    @ExampleObject(
                        name = "PermissionLevelCollection",
