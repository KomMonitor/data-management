...
public interface GeoresourcesPublicApi {
    ...
    @ApiOperation(value = "retrieve all feature entries for all applicable periods of validity for the selected public geo-resource dataset (hence might contain each feature multiple times if they exist for different periods of validity)",
            nickname = "getAllPublicGeoresourceFeaturesById",
            notes = "retrieve all feature entries for all applicable periods of validity for the selected public geo-resource dataset (hence might contain each feature multiple times if they exist for different periods of validity)",
    ...
    ResponseEntity<byte[]> getAllPublicGeoresourceFeaturesById(@ApiParam(value = "the identifier of the public geo-resource dataset", required = true) @PathVariable("georesourceId") String georesourceId,
    ...
    @RequestMapping(value = "/georesources/{georesourceId}/{year}/{month}/{day}",
            ...
            method = RequestMethod.GET)
    ResponseEntity<byte[]> getPublicGeoresourceByIdAndYearAndMonth(@ApiParam(value = "identifier of the public geo-resource dataset", required = true) @PathVariable("georesourceId") String georesourceId,
