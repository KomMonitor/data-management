...
public interface GeoresourcesPublicApi {
    ...
    ResponseEntity<org.springframework.core.io.Resource> exportAllPublicGeoresourceFeaturesById(
        @NotNull @Parameter(name = "georesourceId", description = "unique identifier of the selected public georesource dataset", required = true, in = ParameterIn.PATH) @PathVariable("georesourceId") String georesourceId,
    ...
    ResponseEntity<byte[]> getAllPublicGeoresourceFeaturesById(
        @NotNull @Parameter(name = "georesourceId", description = "the identifier of the public geo-resource dataset", required = true, in = ParameterIn.PATH) @PathVariable("georesourceId") String georesourceId,
    ...
    ResponseEntity<GeoresourceOverviewType> getPublicGeoresourceById(
        @NotNull @Parameter(name = "georesourceId", description = "identifier of the public geo-resource dataset", required = true, in = ParameterIn.PATH) @PathVariable("georesourceId") String georesourceId
    );
