...
public interface AccessControlApi {
    ...
    ResponseEntity<Void> deleteOrganizationalUnit(
        @NotNull @Parameter(name = "organizationalUnitId", description = "organizationalUnitId", required = true, in = ParameterIn.PATH) @PathVariable("organizationalUnitId") String organizationalUnitId
    );
