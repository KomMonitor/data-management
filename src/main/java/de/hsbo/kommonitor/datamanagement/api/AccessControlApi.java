...
public interface AccessControlApi {
    ...
    String PATH_ADD_ORGANIZATIONAL_UNIT = "/organizationalUnits";
    /**
    ...
    @RequestMapping(
        ...
        value = AccessControlApi.PATH_ADD_ORGANIZATIONAL_UNIT,
    ...
    String PATH_DELETE_ORGANIZATIONAL_UNIT = "/organizationalUnits/{organizationalUnitId}";
    /**
    ...
    @RequestMapping(
        ...
        value = AccessControlApi.PATH_DELETE_ORGANIZATIONAL_UNIT
    )
    ...
    String PATH_GET_ORGANIZATIONAL_UNIT_BY_ID = "/organizationalUnits/{organizationalUnitId}";
    /**
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = OrganizationalUnitOverviewType.class), examples = {
                    @ExampleObject(
                        name = "OrganizationalUnitOverview",
                        value = "{\"organizationalUnitId\":\"3c9f8b12-0001-4a1b-9c33-1a2b3c4d5e01\",\"name\":\"District administration\",\"mandant\":true,\"keycloakId\":\"9a8b7c6d-0001-4e2f-8a3b-000000000001\",\"contact\":\"admin@example.org\",\"description\":\"Administration of the example municipality.\",\"parentId\":\"3c9f8b12-0000-4a1b-9c33-1a2b3c4d5e00\",\"mandantId\":\"3c9f8b12-0001-4a1b-9c33-1a2b3c4d5e01\",\"permissions\":[],\"userAdminRoles\":[\"client-resources-creator\"],\"children\":[\"3c9f8b12-0002-4a1b-9c33-1a2b3c4d5e02\"]}"
                    )
                })
    ...
    @RequestMapping(
        ...
        value = AccessControlApi.PATH_GET_ORGANIZATIONAL_UNIT_BY_ID,
    ...
    String PATH_GET_ORGANIZATIONAL_UNIT_PERMISSIONS = "/organizationalUnits/{organizationalUnitId}/permissions";
    /**
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = OrganizationalUnitPermissionOverviewType.class), examples = {
                    @ExampleObject(
                        name = "OrganizationalUnitPermissionOverview",
                        value = "{\"organizationalUnitId\":\"3c9f8b12-0001-4a1b-9c33-1a2b3c4d5e01\",\"name\":\"District administration\",\"contact\":\"admin@example.org\",\"description\":\"Administration of the example municipality.\",\"permissions\":{\"georesources\":[{\"id\":\"0c0d17bb-0001-4a56-9abc-000000000001\",\"permissionLevel\":\"creator\",\"roleId\":\"9a8b7c6d-1001-4e2f-8a3b-000000000001\"}],\"spatialunits\":[{\"id\":\"5a1b2c3d-0001-4e5f-8a9b-000000000001\",\"permissionLevel\":\"editor\",\"roleId\":\"9a8b7c6d-1002-4e2f-8a3b-000000000002\"}],\"indicators\":[{\"id\":\"1d2e3f40-0001-4a5b-8c9d-000000000001\",\"permissionLevel\":\"viewer\",\"roleId\":\"9a8b7c6d-1003-4e2f-8a3b-000000000003\"}],\"indicatorspatialunits\":[{\"id\":\"1d2e3f40-0001-4a5b-8c9d-000000000001\",\"spatialUnitId\":\"5a1b2c3d-0001-4e5f-8a9b-000000000001\",\"permissionLevel\":\"viewer\",\"roleId\":\"9a8b7c6d-1004-4e2f-8a3b-000000000004\"}]}}"
                    )
                })
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = AccessControlApi.PATH_GET_ORGANIZATIONAL_UNIT_PERMISSIONS,
        produces = { "application/json" }
    )
    ResponseEntity<OrganizationalUnitPermissionOverviewType> getOrganizationalUnitPermissions(
        @Parameter(name = "organizationalUnitId", description = "organizationalUnitId", required = true, in = ParameterIn.PATH) @PathVariable("organizationalUnitId") String organizationalUnitId,
        @Parameter(name = "resourceType", description = "resourceType", in = ParameterIn.QUERY) @Valid @RequestParam(value = "resourceType", required = false) @Nullable ResourceType resourceType
    );


    String PATH_GET_ORGANIZATIONAL_UNIT_ROLE_AUTHORITIES = "/organizationalUnits/{organizationalUnitId}/role-authorities";
    /**
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = OrganizationalUnitRoleAuthorityType.class), examples = {
                    @ExampleObject(
                        name = "OrganizationalUnitRoleAuthority",
                        value = "{\"authorityRoles\":[{\"organizationalUnitId\":\"3c9f8b12-0001-4a1b-9c33-1a2b3c4d5e01\",\"adminRoles\":[\"client-resources-creator\",\"client-themes-creator\"]}]}"
                    )
                })
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = AccessControlApi.PATH_GET_ORGANIZATIONAL_UNIT_ROLE_AUTHORITIES,
        produces = { "application/json" }
    )
    ...
    String PATH_GET_ORGANIZATIONAL_UNIT_ROLE_DELEGATES = "/organizationalUnits/{organizationalUnitId}/role-delegates";
    /**
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = OrganizationalUnitRoleDelegateType.class), examples = {
                    @ExampleObject(
                        name = "OrganizationalUnitRoleDelegate",
                        value = "{\"roleDelegates\":[{\"organizationalUnitId\":\"3c9f8b12-0002-4a1b-9c33-1a2b3c4d5e02\",\"adminRoles\":[\"unit-resources-creator\"]}]}"
                    )
                })
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = AccessControlApi.PATH_GET_ORGANIZATIONAL_UNIT_ROLE_DELEGATES,
        produces = { "application/json" }
    )
    ...
    String PATH_GET_ORGANIZATIONAL_UNITS = "/organizationalUnits";
    /**
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = OrganizationalUnitOverviewType.class)), examples = {
                    @ExampleObject(
                        name = "OrganizationalUnitOverviewCollection",
                        value = "[{\"organizationalUnitId\":\"3c9f8b12-0001-4a1b-9c33-1a2b3c4d5e01\",\"name\":\"District administration\",\"mandant\":true,\"keycloakId\":\"9a8b7c6d-0001-4e2f-8a3b-000000000001\",\"contact\":\"admin@example.org\",\"parentId\":\"3c9f8b12-0000-4a1b-9c33-1a2b3c4d5e00\",\"permissions\":[],\"userAdminRoles\":[\"client-resources-creator\"],\"children\":[]}]"
                    )
                })
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = AccessControlApi.PATH_GET_ORGANIZATIONAL_UNITS,
        produces = { "application/json" }
    )
    ...
    String PATH_SYNC_ALL_ORGANIZATIONAL_UNITS = "/organizationalUnits/sync";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.POST,
        value = AccessControlApi.PATH_SYNC_ALL_ORGANIZATIONAL_UNITS
    )
    ...
    String PATH_SYNC_ORGANIZATIONAL_UNIT = "/organizationalUnits/{organizationalUnitId}/sync";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.POST,
        value = AccessControlApi.PATH_SYNC_ORGANIZATIONAL_UNIT
    )
    ...
    String PATH_UPDATE_ORGANIZATIONAL_UNIT = "/organizationalUnits/{organizationalUnitId}";
    /**
    ...
    @RequestMapping(
        ...
        value = AccessControlApi.PATH_UPDATE_ORGANIZATIONAL_UNIT,
        consumes = { "application/json" }
    )
    ...
    String PATH_UPDATE_ROLE_DELEGATES = "/organizationalUnits/{organizationalUnitId}/role-delegates";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.PUT,
        value = AccessControlApi.PATH_UPDATE_ROLE_DELEGATES,
        consumes = { "application/json" }
    )
