...
public interface SpatialUnitsPublicApi {
     ...
     */
    @Operation(
        operationId = "getAllSpatialUnitFeaturesById1",
    ...
    ResponseEntity<String> getAllSpatialUnitFeaturesById1(
    ...
    ResponseEntity<String> getPublicSingleSpatialUnitFeatureById(
    ...
    ResponseEntity<String> getPublicSingleSpatialUnitFeatureRecordById(
        @Parameter(name = "featureId", description = "the identifier of the spatial-unit dataset feature", required = true, in = ParameterIn.PATH) @PathVariable("featureId") String featureId,
    ...
    ResponseEntity<SpatialUnitOverviewType> getSpatialUnits1(
     ...
     */
    @Operation(
        operationId = "getSpatialUnitsById1",
    ...
    ResponseEntity<SpatialUnitOverviewType> getSpatialUnitsById1(
        @Parameter(name = "spatialUnitId", description = "the unique identifier of the spatial level", required = true, in = ParameterIn.PATH) @PathVariable("spatialUnitId") String spatialUnitId
    );
     ...
     */
    @Operation(
        operationId = "getSpatialUnitsByIdAndYearAndMonth1",
    ...
    ResponseEntity<byte[]> getSpatialUnitsByIdAndYearAndMonth1(
     ...
     */
    @Operation(
        operationId = "getSpatialUnitsSchemaById1",
    ...
    ResponseEntity<String> getSpatialUnitsSchemaById1(
        @Parameter(name = "spatialUnitId", description = "the unique identifier of the spatial level", required = true, in = ParameterIn.PATH) @PathVariable("spatialUnitId") String spatialUnitId
    );
