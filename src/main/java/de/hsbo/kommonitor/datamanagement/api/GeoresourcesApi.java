...
public interface GeoresourcesApi {
    ...
    ResponseEntity<Void> deleteAllGeoresourceFeaturesById(
        @NotNull @Parameter(name = "georesourceId", description = "the identifier of the geo-resource dataset", required = true, in = ParameterIn.PATH) @PathVariable("georesourceId") String georesourceId
    );
    ...
    ResponseEntity<Void> deleteGeoresourceById(
        @NotNull @Parameter(name = "georesourceId", description = "identifier of the geo-resource dataset", required = true, in = ParameterIn.PATH) @PathVariable("georesourceId") String georesourceId
    );
    ...
    ResponseEntity<Void> deleteGeoresourceByIdAndYearAndMonth(
        @NotNull @Parameter(name = "georesourceId", description = "identifier of the geo-resource dataset", required = true, in = ParameterIn.PATH) @PathVariable("georesourceId") String georesourceId,
        @NotNull @Parameter(name = "year", description = "year for which datasets shall be queried", required = true, in = ParameterIn.PATH) @PathVariable("year") BigDecimal year,
        @NotNull @Parameter(name = "month", description = "month for which datasets shall be queried", required = true, in = ParameterIn.PATH) @PathVariable("month") BigDecimal month,
    ...
    ResponseEntity<Void> deleteSingleGeoresourceFeatureById(
        @NotNull @Parameter(name = "georesourceId", description = "the identifier of the geo-resource dataset", required = true, in = ParameterIn.PATH) @PathVariable("georesourceId") String georesourceId,
        @NotNull @Parameter(name = "featureId", description = "the identifier of the geo-resource dataset feature", required = true, in = ParameterIn.PATH) @PathVariable("featureId") String featureId
    );
    ...
    ResponseEntity<org.springframework.core.io.Resource> exportAllGeoresourceFeaturesById(
        @NotNull @Parameter(name = "georesourceId", description = "unique identifier of the selected georesource dataset", required = true, in = ParameterIn.PATH) @PathVariable("georesourceId") String georesourceId,
    ...
    ResponseEntity<byte[]> getAllGeoresourceFeaturesByIdWithoutGeometry(
        @NotNull @Parameter(name = "georesourceId", description = "georesourceId", required = true, in = ParameterIn.PATH) @PathVariable("georesourceId") String georesourceId
    );
    ...
    ResponseEntity<byte[]> getGeoresourceByIdAndYearAndMonthWithoutGeometry(
        @NotNull @Parameter(name = "georesourceId", description = "georesourceId", required = true, in = ParameterIn.PATH) @PathVariable("georesourceId") String georesourceId,
        @NotNull @Parameter(name = "year", description = "year", required = true, in = ParameterIn.PATH) @PathVariable("year") BigDecimal year,
        @NotNull @Parameter(name = "month", description = "month", required = true, in = ParameterIn.PATH) @PathVariable("month") BigDecimal month,
        @NotNull @Parameter(name = "day", description = "day", required = true, in = ParameterIn.PATH) @PathVariable("day") BigDecimal day
    );
